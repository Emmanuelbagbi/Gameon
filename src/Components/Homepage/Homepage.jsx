...
function Hompage() {
    ...
    useEffect(() => {
        // Initialize ScrollReveal for each group of elements
        ScrollReveal().reveal('.container h6', {
          distance: '40px',
          duration: 2500,
          reset: true,
          origin: 'left',
    ...
    return(
        <>
                <header>
                    <a href="#" className="logo">Gameon</a>
                    ...
                    <div className="right-nav">
                        <a href="#" className="h-btn">Download</a>
                ...
                <section className='hero'>
                    <div className="container">
                        ...
                        <h3>Epic Games</h3>
                        <h1>Fortnite</h1>
                        <p>All the games, all the time. No additional purchases or revolving
                            Monthly Catalogs. Play Whatever you want,
                            Whenever you want, as many times as you want.
                        </p>

                        <div className="main-btnn">
                            <a href="#">Play now</a>
                            <a href="#" className='cta'><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-play-fill" viewBox="0 0 16 16">
                ...
                <div className="social">
                    <a href="#"><i className="bi bi-windows"></i></a>
                    <a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-windows" viewBox="0 0 16 16">
